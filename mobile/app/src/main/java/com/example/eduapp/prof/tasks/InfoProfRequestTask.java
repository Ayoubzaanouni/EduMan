...
public class InfoProfRequestTask extends AsyncTask<String, Void, String> {

    private static final String TAG = InfoProfRequestTask.class.getSimpleName();
    private final OnRequestCompletedListener listener;

    public InfoProfRequestTask(OnRequestCompletedListener listener) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            URL url = new URL(IP_ADRESS+"/api/profs/InfoProf?email=" + email);
